...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        // Add your sprite variables here

        // Create an array to store Texture2D objects
        // by putting [] you specify an array, in [5] you specify the number of elements you want to store
        
        //int[] myArray1 = new int[10]; // one-dimensional array
        //int[,] myArray2 = new int[5,2]; // two-dimensional array
        //int[,,] myArray3 = new int[5, 2, 4]; // three-dimensional array

        //Using an array
        //Texture2D[] character = new Texture2D[5];

        // Using a Collection Classes
        List<Texture2D> character = new List<Texture2D>();
        ...
        protected override void LoadContent()
        {
            ...
            //Using an array to add elements
            //character[0] = Content.Load<Texture2D>("Tomato_100x100");
            //character[1] = Content.Load<Texture2D>("Pear_100x100");
            //character[2] = Content.Load<Texture2D>("Banana_100x100");
            //character[3] = Content.Load<Texture2D>("Kiwi_100x100");
            //character[4] = Content.Load<Texture2D>("Cherry_100x100");


            //Using a Class Collection to add elements
            character.Add(Content.Load<Texture2D>("Tomato_100x100"));
            character.Add(Content.Load<Texture2D>("Pear_100x100"));
            character.Add(Content.Load<Texture2D>("Banana_100x100"));
            character.Add(Content.Load<Texture2D>("Kiwi_100x100"));
            character.Add(Content.Load<Texture2D>("Cherry_100x100"));
        ...
        protected override void Update(GameTime gameTime)
        {
                ...
                previousButtinState == ButtonState.Pressed)
            {
                ...
                currentCharacter = character[rand.Next(5)];
