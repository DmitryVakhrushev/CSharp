...
namespace FishAndBears
{
    ...
    public class MenuButton
    {
        ...
        public MenuButton(ContentManager contentManager,
            Texture2D sprite, Vector2 center, GameState clickState)
        {
            this.sprite = sprite;
            this.clickState = clickState;
            Initialize(center);
            buttonClick = contentManager.Load<SoundEffect>("buttonClick");
        }
